...
function validate(minLength, value){
    var minPasswordLength = minLength
    var passwordInput = value
    ...
    // error codes
    var legthErrorCode = 0 // 0 = safe, 1 = poor
    var numErrorCode = 0 // 0 = safe, 1 = poor
    ...
    exceptions = excetionsString.split("\n")
    ...
    for(let index = 0; index < passwordInput.length; index++){
        ...
        for(let numberIndex = 0; numberIndex < numbers.length; numberIndex++){
            if(passwordInput.includes(numbers[numberIndex])){
                masterNumErrorCode = 0
                numErrorCode = 0
            }
            else {
                numErrorCode = 1
    ...
    for(let index = 0; index < passwordInput.length; index++){
        ...
        for(let symbowlIndex = 0; symbowlIndex < symbols.length; symbowlIndex++){
            if(passwordInput.includes(symbols[symbowlIndex])){
                masterSymbowlErrorCode = 0
                symbowlErrorCode = 1
            }
            else {
                symbowlErrorCode = 1
    ...
    if(masterNumErrorCode === numErrorCode){
    ...
    if(masterSymbowlErrorCode === symbowlErrorCode){
        symbowlErrorCode = masterSymbowlErrorCode
    } else {
        symbowlErrorCode = masterSymbowlErrorCode
    }

    //Set ErrorCode
    validateErrorCode = `${legthErrorCode}${useabilityErrorCode}${numErrorCode}${symbowlErrorCode}`
    ...
    if(symbowlErrorCode == 1){
        strengthLevel -= 1
    }
    else{
        strengthLevel -= 0
    }
    if(useabilityErrorCode == 1){
        strengthLevel -= 1
    }
    else{
        strengthLevel -= 0
    ...
    exports.legthErrorCode = legthErrorCode;
    exports.numErrorCode = numErrorCode;
    exports.symbowlErrorCode = symbowlErrorCode;
    exports.useabilityErrorCode = useabilityErrorCode;
